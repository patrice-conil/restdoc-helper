...
import com.orange.otml.Constant;
...
public class ProgramController {
    ...
    /**
     * Programs com.orange.otml.service.
     */
    @Autowired
    ...
    public ResponseEntity<List<Program>> getPrograms(
        ...
        LOGGER.info("[getLightPrograms] date={}, application={}, channels={}, offset={}, limit={}",
        ...
        ResponseEntity<List<Program>> responseEntity = ResponseEntity.ok()
                .body(lightPaginated);
        LOGGER.debug("[getLightPrograms] response = {}", responseEntity.toString());
